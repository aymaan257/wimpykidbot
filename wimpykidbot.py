...
@tree.command(name="help", description="Show commands", guild=discord.Object(id=GUILD_ID))
async def help_cmd(interaction: discord.Interaction):
    await interaction.response.send_message(
        "📖 Commands:\n/help\n/trivia\n/quote\n/lock (admins)\n/unlock (admins)"
    )

@tree.command(name="lock", description="Lock bot to this channel (Admins only)", guild=discord.Object(id=GUILD_ID))
async def lock(interaction: discord.Interaction):
    ...
    await interaction.response.send_message(f"🔒 Bot locked to {interaction.channel.mention}")

@tree.command(name="unlock", description="Unlock bot (Admins only)", guild=discord.Object(id=GUILD_ID))
...
@tree.command(name="quote", description="Get a Wimpy Kid quote", guild=discord.Object(id=GUILD_ID))
async def quote(interaction: discord.Interaction):
    if not is_locked_channel(interaction):
        await interaction.response.send_message("❌ Bot locked in another channel.", ephemeral=True)
        return
